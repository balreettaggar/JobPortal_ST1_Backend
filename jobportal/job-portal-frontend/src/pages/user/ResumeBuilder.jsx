...
//         <button className="rb-download-btn" onClick={handleDownloadPDF}>
//           Download PDF
//         </button>
//       </div>
...
//             <input name="fullName" value={data.fullName} onChange={onChange} placeholder="Asmita Sharma" />
//           </div>
//           <div className="rb-row rb-2col">
//             <div>
//               <label>Email</label>
//               <input name="email" value={data.email} onChange={onChange} placeholder="asmita@example.com" />
//             </div>
//             <div>
//               <label>Phone</label>
//               <input name="phone" value={data.phone} onChange={onChange} placeholder="+91 98xxxxxxx" />
//             </div>
//           </div>
//           <div className="rb-row">
//             <label>Address</label>
//             <input name="address" value={data.address} onChange={onChange} placeholder="City, State, Country" />
//           </div>
...
//           <div
//             ref={previewRef}
//             className={`rb-preview a4 ${template === "modern" ? "tpl-modern" : "tpl-classic"}`}
//           >
//             {template === "modern" ? (
...
//                   <div className="c-sub">
//                     {data.email || "email@example.com"} • {data.phone || "+91 9xxxxxxxxx"} •{" "}
...
// src/pages/user/ResumeBuilder.jsx
// import React, { useMemo, useRef, useState } from "react";
// import html2canvas from "html2canvas";
// import jsPDF from "jspdf";
...
//     const payload = {
//       // include both `name` and `fullName` to cover different backend schemas
//       name: data.fullName,
...
//         // setData({ fullName: "", email: "", phone: "", address: "", summary: "", skills: "", education: "", experience: "", projects: "", links: "" });
//       } else {
...
//     // small pause so fonts/DOM settle
...
//           {/* optional inline submit for keyboard users */}
...
//                     <h4>Skills</h4>
//                     <ul className="pill-list">
//                       {skillList.length ? skillList.map((s, i) => <li key={i}>{s}</li>) : <li>React</li>}
//                     </ul>
//                   </div>
//                   {data.links && (
//                     <div className="m-section">
//                       <h4>Links</h4>
//                       <ul className="bullet-list">{splitLines(data.links).map((l, i) => <li key={i}>{l}</li>)}</ul>
//                     </div>
//                   )}
//                 </aside>
...
//                     <section>
//                       <h3>Experience</h3>
//                       <ul className="bullet-list">{splitLines(data.experience).map((e, i) => <li key={i}>{e}</li>)}</ul>
//                     </section>
//                   )}
...
//                     <section>
//                       <h3>Projects</h3>
//                       <ul className="bullet-list">{splitLines(data.projects).map((p, i) => <li key={i}>{p}</li>)}</ul>
//                     </section>
//                   )}
...
//                     <section>
//                       <h3>Education</h3>
//                       <ul className="bullet-list">{splitLines(data.education).map((ed, i) => <li key={i}>{ed}</li>)}</ul>
//                     </section>
//                   )}
//                 </main>
//               </div>
...
//                   <h2>{data.fullName || "Your Name"}</h2>
//                   <div className="c-sub">
//                     {data.email || "email@example.com"} • {data.phone || "+91 9xxxxxxxxx"} • {data.address || "City, State"}
//                   </div>
//                 </header>
...
//                   <section className="c-section">
//                     <h3>Skills</h3>
//                     <div className="chip-row">{skillList.map((s, i) => <span className="chip" key={i}>{s}</span>)}</div>
//                   </section>
//                 )}
...
//                   <section className="c-section">
//                     <h3>Experience</h3>
//                     <ul>{splitLines(data.experience).map((e, i) => <li key={i}>{e}</li>)}</ul>
//                   </section>
//                 )}
...
//                   <section className="c-section">
//                     <h3>Projects</h3>
//                     <ul>{splitLines(data.projects).map((p, i) => <li key={i}>{p}</li>)}</ul>
//                   </section>
//                 )}
...
//                   <section className="c-section">
//                     <h3>Education</h3>
//                     <ul>{splitLines(data.education).map((ed, i) => <li key={i}>{ed}</li>)}</ul>
//                   </section>
//                 )}
...
//                   <section className="c-section">
//                     <h3>Links</h3>
//                     <ul>{splitLines(data.links).map((l, i) => <li key={i}>{l}</li>)}</ul>
//                   </section>
//                 )}
//               </div>
//             )}
...
//           <div className="rb-note">Tip: Switch templates from the dropdown before downloading.</div>
//         </div>
//       </div>
//     </div>
//   );
